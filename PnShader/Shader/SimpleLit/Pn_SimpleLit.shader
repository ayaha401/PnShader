...
Shader "Universal Render Pipeline/Pn/SimpleLit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            // -------------------------------------
            // Includes
            #include "Assets/AyahaShader/PnShader/Shader/SimpleLit/Pn_SimpleLitInput.hlsl"
            #include "Assets/AyahaShader/PnShader/Shader/SimpleLit/Pn_SimpleLitForwardPass.hlsl"
            ENDHLSL
        }
